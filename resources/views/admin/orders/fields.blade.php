    ...
    var action = document.getElementById("action");
     ...
     $('#add').click(function(){
      ...
      var html_code = "<tr id='row"+count+"' class='trbody'>";
       ...
       html_code += "<td ' class='toko_id' style='display:none'  ><input type='hidden' name='row["+count+"][toko_id]' class='form-control toko_id search_text' id='toko_id'/></td>";
       html_code += "<td ' class='kategori_id' style='display:none'  ><input type='hidden' name='row["+count+"][kategori_id]' class='form-control kategori_id search_text' id='kategori_id'/></td>";
    ...
    var action = '<?php echo @$action; ?>';
       ...
       function additionalTable()
     {
      ...
      document.getElementById("countdetail").value = count;
       ...
       html_code += "<td ' class='subtotal' ><input type='text' name='row["+count+"][subtotal]' class='form-control subtotal' id='subtotal' readonly/></td>";
       html_code += "<td ' class='laba' style='display:none'  ><input type='hidden' name='row["+count+"][laba]' class='form-control laba' id='laba' readonly/></td>";
       html_code += "<td ' class='toko_id' style='display:none'  ><input type='hidden' name='row["+count+"][toko_id]' class='form-control toko_id search_tex' id='toko_id' /></td>";
       html_code += "<td ' class='kategori_id' style='display:none'  ><input type='hidden' name='row["+count+"][kategori_id]' class='form-control kategori_id search_tex' id='kategori_id' /></td>";
       html_code += "<td><button type='button' name='remove' data-row='row"+count+"' class='btn btn-danger btn-xs remove'>-</button></td>";   
       html_code += "</tr>";  
       $('#crud_table').append(html_code);
     }
